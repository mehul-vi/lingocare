...
function Topic({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 border-l-4 border-l-[#EC8601] bg-[#f5f6f8]">
      ...
      <div className="px-4 py-3.5">
        ...
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded text-gray-400 transition hover:bg-white hover:text-gray-700"
            aria-label={
              isOpen
                ? "Collapse topic"
                : "Expand topic"
          ...
          <div className="min-w-0 flex-1">
            ...
            {editingTitle ? (
              ...
              <p
                ...
                className="cursor-text text-sm font-semibold text-gray-900 transition hover:text-[#EC8601]"
              >
                {topic.title ||
                  "Untitled Topic"}
              </p>
            ...
            {editingDescription ? (
              <textarea
                ...
                rows={2}
                className="mt-1.5 w-full resize-none rounded-md border border-[#EC8601] bg-white px-2 py-1.5 text-sm text-gray-600 outline-none"
              />
            ) : (
              <p
                onClick={() =>
      ...
      {/* Topic Content */}
      {isOpen && (
        <div className="px-4 pb-4 pl-10 sm:pl-12">
